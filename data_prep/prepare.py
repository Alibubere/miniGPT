...
def prepare_data(file_path,output_dir,train_file_name,val_file_name,vocab_size:int = 256):
    ...
    logging.info(f"Success! Train size: {len(train_ids_np)}, Val size: {len(val_ids_np)}")
